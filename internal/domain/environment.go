...
type Environment struct {
	...
	GlobalHeaders *[]string `json:"global_headers" db:"global_headers"`
	GlobalAuth    *[]string `json:"global_auth" db:"global_auth"`
...
type ValidationEnvironment struct {
	...
	GlobalHeaders *[]string `json:"global_headers" binding:"required,dive,required"`
	GlobalAuth    *[]string `json:"global_auth" binding:"required,dive,required"`
}
